...
echo "<h3> Trupti Your Web Running Apache with php on Frontend container </h3>";
echo "<h3> Trupti Your APP Running Test  Apache and PHP providing API services for User information on url http://backend/get_user_details </h2>";
echo "<h3> Trupti Your Database running Mysql/Mariadb holding user information in userdb on users Table </h1>";
